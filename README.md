<img width="253" height="538" alt="image" src="https://github.com/user-attachments/assets/86e1ddf1-d2ae-4756-8a82-60a894471ca9" /># Corp Portal  
...
![фильтр и сортировка развернуты](screenshots/employees-table/server-filters-and-sorting-ex1.png)
...
![фильтр свернут](screenshots/employees-table/server-filters-and-sorting-ex2.png)

После нажатия на кнопку сброса в развернутом окне инструмента, фильтры/сортировка сбрасывается и окно сварачивается:

![сортировка сброшена](screenshots/employees-table/server-filters-and-sorting-ex3.png)
